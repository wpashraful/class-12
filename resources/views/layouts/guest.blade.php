                ...
                <div class="container flex justify-between pb-[50px]">
                    <div>
                        ...
                        <ul class="mt-5">
                            ...
                            <li class="mb-2">
                                <a href="{{route('archive',['series', 'vue'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Vue.js</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <ul class="mt-5">
                            <li class="mb-2">
                                <a href="{{route('archive',['archive', 'eloquent'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Eloquent</a>
                            </li>
                            <li class="mb-2">
                                <a href="{{route('archive',['archive', 'validation'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Validation</a>
                            </li>
                            <li class="mb-2">
                                <a href="{{route('archive',['archive', 'refactoring'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Refactoring</a>
                            </li>
                            <li class="mb-2">
                                <a href="{{route('archive',['archive', 'testing'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Testing</a>
                            </li>
                        </ul>
                    </div>
                </div>
