            ...
            <section aria-labelledby="courses-heading" class="pt-6 pb-12">
                ...
                <div class="flex gap-x-8 gap-y-10">
                        ...
                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" x-show="! open" style="display: none;">
                          <path d="M10.75 4.75a.75.75 0 00-1.5 0v4.5h-4.5a.75.75 0 000 1.5h4.5v4.5a.75.75 0 001.5 0v-4.5h4.5a.75.75 0 000-1.5h-4.5v-4.5z"></path>
                            ...
                            <div class="pt-6">
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input name="level" @if(array_key_exists('level' , $_GET) && $_GET['level']=== '0')  checked @endif id="filter-level-beginner" value="0" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 form-submit">
                                        <label for="filter-level-beginner" class="ml-3 text-sm text-gray-600"> Beginner <span class="text-xs text-gray-500">(10)</span>
                                        </label>
                                    </div>
                                    <div class="flex items-center">
                                        <input name="level"  @if(array_key_exists('level' , $_GET) && $_GET['level']=== '1')  checked @endif id="filter-level-intermediate" value="1" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 form-submit">
                                    ...
                                    <div class="flex items-center">
                                        <input name="level"  @if(array_key_exists('level' , $_GET) && $_GET['level']=== '2')  checked @endif id="filter-level-advanced" value="2" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 form-submit">
                    ...
                    <script>
                        ...
                        // const beginnerCheckbox = document.getElementById('filter-level-beginner');
                        // const intermediateCheckbox = document.getElementById('filter-level-intermediate');
                        // const advancedCheckbox = document.getElementById('filter-level-advanced');
                        //
                        // beginnerCheckbox.addEventListener('change', (event) => {
                        //     const isChecked = event.target.checked;
                        //     const level = event.target.value;
                        //     updateCourses(isChecked, level);
                        // });
                        //
                        // intermediateCheckbox.addEventListener('change', (event) => {
                        //     const isChecked = event.target.checked;
                        //     const level = event.target.value;
                        //     updateCourses(isChecked, level);
                        // });
                        ...
                        // });
                        //
                        // function updateCourses(isChecked, level) {
                        //     if (isChecked) {
                        //         // Add the level to the query
                        //         $courses = DB::table('courses')
                        //     ->where('level', level)
                        //     ->get();
                        //     } else {
                        //         // Remove the level from the query
                        //         $courses = DB::table('courses')
                        //     ->where('level', '!=', level)
                        //     ->get();
                        //     }
                                        ...
                                        <div class="flex">
                                            <div class="flex-1 overflow-flex-wrap">
                                                <h2 class="text-xl font-bold text-gray-900 mb-1">
                                                    <a href="single.html" class="text-blue-500 hover:underline">{{$course->name}}</a>
                                                </h2>
